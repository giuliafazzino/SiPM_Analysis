void analysis_A1(TString fFName960a = "",TString fFName980a = "",TString fFName1000a = "",
    ...
    TCanvas *cA1_bias = new TCanvas("cA1_"+var, "cA1_"+var, 800, 2400);
    cA1_bias->Divide(1, 3);
    cA1_bias->cd(1);
    ...
    cA1_bias->SaveAs("cA1_" + var + ".root");
    cA1_bias->SaveAs("cA1_" + var + ".pdf");
    delete cA1_bias;
